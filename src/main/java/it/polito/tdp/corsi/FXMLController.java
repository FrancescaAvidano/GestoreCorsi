...
public class FXMLController {
    ...
    @FXML // fx:id="txtNumeroStudenti"
    private Button txtNumeroStudenti; // Value injected by FXMLLoader

    @FXML // fx:id="btnStudenti"
    private Button btnStudenti; // Value injected by FXMLLoader

    @FXML // fx:id="txtDivisioneStudenti"
    private Button txtDivisioneStudenti; // Value injected by FXMLLoader
    ...
    void stampaDivisione(ActionEvent event) {
    	...
    	//OUTPUT Dato un corso, ci aspettiamo una divisione con "nome laurea" "num stud iscritti"
    	//Informatica 12
    	//Gestionali 28
    ...
    void initialize() {
        ...
        assert txtNumeroStudenti != null : "fx:id=\"txtNumeroStudenti\" was not injected: check your FXML file 'Scene.fxml'.";
        assert btnStudenti != null : "fx:id=\"btnStudenti\" was not injected: check your FXML file 'Scene.fxml'.";
        assert txtDivisioneStudenti != null : "fx:id=\"txtDivisioneStudenti\" was not injected: check your FXML file 'Scene.fxml'.";
